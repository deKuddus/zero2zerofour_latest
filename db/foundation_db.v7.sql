...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2020 at 12:16 PM
...
(12, '5edc6e4c4aa2f', 0, 1, 'Get Premium Membership', 1, '100.00', '0.00', '0.00', '100.00', '', NULL, NULL, 'membership');
...
INSERT INTO `event_transaction` (`id`, `order_id`, `mer_txnid`, `store_amount`, `pay_time`, `bank_txn`, `card_number`, `card_holder`, `card_type`, `item_name`, `item_total_quantity`, `item_price`) VALUES
(1, 4234234, 'fghgh567gbh', '100', '4567hj', '567hjk', '5678hjk', 'sdfghjkl', 'sdfghjkl', 'dfghjkl', 12, '100.00');
...
CREATE TABLE `members` (
  ...
  `registration_card` text DEFAULT NULL,
...
INSERT INTO `members` (`id`, `member_id`, `name`, `email`, `mobile`, `street_address`, `police_station`, `date_of_birth`, `post_code`, `country`, `state`, `password`, `member_photo`, `registration_card`, `designation`, `board_member_order`, `is_active`, `password_reset_code`, `premium_member`, `life_member`) VALUES
(6, NULL, 'Md Jasim Uddin', 'jasim@gmail.com', '01234567891', '5 no road', 'nasirabad', '0000-00-00', '4225', 'Bangladesh', 'Chittagong', '$argon2i$v=19$m=2048,t=4,p=3$cDVxVDRsN2YyUGNDSzZmMQ$CSEkN9ZNGSfm6jqjxk1l5C2BOGI3667Ri82CLrLICPw', 'member/5473e4014fd5afa57de9f86e810d98e6.jpg', 'member/9ac6e39c100ee6c34dde03867fe56a90.jpg', '1', 1, 1, NULL, 1, 1),
(13, 'MID-2020-06-1001', 'Electronics', 'admin@admi.com', '123456789034567', 'asdfghj', 'adsfasdf', '2020-06-06', '34234', 'Belarus', 'Minskaya', '$argon2i$v=19$m=2048,t=4,p=3$NkZ4di9iS25nYUF3SDhIMw$Nih2/UW73wd451AxOm+VuoY3gh116jAuJmpmXBIS+Ig', 'member/2cf9c624c54ad5ac444ab9c85a067e71.png', 'member/8754f794233a1cd10dcde7b26478329f.jpg', '0', NULL, 0, NULL, 0, 0),
(14, 'MID-2020-06-1001', 'child category', 'kuddus@gmail.com', '123456789034567', 'asdfghj', 'adsfasdf', '1990-01-30', '3434', 'Bahrain', 'Madinat \'Isa', '$argon2i$v=19$m=2048,t=4,p=3$cndhMWVjWHZZOXNkVEtSSg$Td+giF3yTuGAWXWpG31WXGZSxPgRh6ORpn2eE58c3lM', 'member/395f409fd9213d01e6a5a7baf8a7fb79.jpg', 'member/6b44aba509c626e8032769f1e2a6124f.jpg', '0', NULL, 0, NULL, 0, 0),
(15, 'MID-2020-06-1002', 'Test Brand', 'asdf2@asdasd.co', '123456789034567', 'asdfghj', 'adsfasdf', '2020-10-07', 'asdfasd', 'Bahrain', 'Al Muharraq', '$argon2i$v=19$m=2048,t=4,p=3$bzJmSFEyLnUzNTg4Q1pXYQ$bCODBOfBg0xQ5q2wMNJrqh/dJAQAFipKjvEsUuqByI8', 'member/5e686b4670ca0819ae9d6a97e69e4c64.png', 'member/c9de5eb7908ae6fb6cbac0c0ce86e4c1.jpg', '0', NULL, 0, NULL, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `membership_config`
--

CREATE TABLE `membership_config` (
  `id` int(11) NOT NULL,
  `member_ship_type` varchar(100) NOT NULL,
  `features` text NOT NULL,
  `price` decimal(8,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `membership_config`
--

INSERT INTO `membership_config` (`id`, `member_ship_type`, `features`, `price`) VALUES
(1, 'Get Premium Membership', 'test', '100.00'),
(2, 'Get Life-Time Membership', 'test', '210.00');
...
(1, '127.0.0.1', 'administrator', '$2y$12$FvfpQho1FzlkN/BNP557yeQ//.aBWRJoyoetxmfQeUEfv4PdbdOxC', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1591507289, 1, 'Admin', 'istrator', 'ADMIN', '0', 'administration/443d2456b5b0d2fc47908803b086ae1e.jpg'),
...
CREATE TABLE `volunteers` (
  ...
  `country` varchar(100) NOT NULL,
  `state` varchar(100) NOT NULL,
  `volunteer_photo` text DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `volunteers` (`id`, `name`, `email`, `mobile`, `date_of_birth`, `street_address`, `address_line`, `police_station`, `post_code`, `country`, `state`, `volunteer_photo`, `is_active`, `v_id`, `occupation`) VALUES
(11, 'Hasibur Rahman', 'hasib@gmail.com', '01234567891', NULL, ' khulsi ', '4 no. road', 'chittagong', '4225', 'Bangladesh', 'Chittagong', 'volunteer/e73f4a51a675ad225d77c5a0da0cbf5b.jpg', 1, '0204-v-2020-06-1591510140', NULL);
...
--
-- Indexes for table `cause_transaction`
--
ALTER TABLE `cause_transaction`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `membership_config`
--
...
--
-- AUTO_INCREMENT for table `cause_transaction`
--
ALTER TABLE `cause_transaction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `membership_config`
--
ALTER TABLE `membership_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
