  ...
  <div class="ibox ">
    <div class="ibox-content">
      <div class="row">
        ...
        <div class="col-md-8">
        <form id="donor_form_edit" method="post" class="form-horizontal form-label-left">
          <h3>UPDATE DONOR</h3>
          ...
          <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" value="<?php echo $donor->name; ?>">
            <div class="form-error danger-text"></div>
          </div>
          <div class="form-group">
            <label for="email">Email <code class="danger-text">*</code> </label>
            <input type="email" id="email" name="email" class="form-control" value="<?php echo $donor->email; ?>">
            <div class="form-error danger-text"></div>
          </div>
          <input type="hidden" name="donor_id" value="<?php echo $donor->id; ?>">
          <div class="form-group">
            <label for="tel">Phone <code class="danger-text">*</code> </label>
            <input type="tel" id="tel" name="mobile" class="form-control" value="<?php echo $donor->mobile; ?>">
            <div class="form-error danger-text"></div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <label for="donor_photo"><img src="<?php echo image_url($donor->donor_photo); ?>" id="donor_photo_preview" height="150px" width="100%" style="border-radius: 5px; "></label>
