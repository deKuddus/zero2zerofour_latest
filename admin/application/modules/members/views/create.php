  ...
  <div class="ibox ">
    <div class="ibox-content">
      <div class="row">
        ...
        <div class="col-md-8">
        <form id="member_form" method="post" class="form-horizontal form-label-left">
          <h3>NEW MEMBER REGISTRAION FORM </h3>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <label for="member_photo"><img src="<?php echo image_url('member/default.png'); ?>" id="member_photo_preview" height="200px" width="200px" style="border-radius: 5px; "></label>
