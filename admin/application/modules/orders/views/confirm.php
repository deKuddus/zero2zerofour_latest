...
<div class="wrapper wrapper-content animated fadeInRight">
  ...
  <div class="col-sm-8">
      <div class="title-action">
        <?php echo go_back(); ?>
        <a href="<?php echo base_url('orders'); ?>" class="btn btn-primary">View Pending Order</a>
      </div>
    </div>
  </div>
  ...
  <div class="ibox ">
    <div class="ibox-content">
      <div class="table-responsive">
        <table id="pending_orders_list" class="table table-striped table-bordered table-hover" >
          <thead>
            <tr>
              <th>No.</th>
              <th>Address</th>
