...
<div class="invoice-box">
    <table>
        <tr>
            <td class="myco">
                <img src="<?php echo base_url('public/assets/images/logo.png'); ?>" style="max-width:260px;">
            </td>
            <td>
            ...
            <td class="myw">
                <table class="top_sum">
                   <tr>
                    ...
                    <tr>
                        <td><?php echo "Invoice Date"; ?></td><td><?php echo date_format(date_create($order['order']->order_at), 'd-M-Y'); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo "Due Date"; ?></td><td><?php echo date_format(date_create($order['order']->order_at), 'd-M-Y'); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
?>
                            ...
                            <td>
                    <?php
echo '<strong>' . $order['order']->customer_name . '</strong><br>';
...
foreach ($order['order_list'] as $product) {
    ...
    if ($product->type != 'product') {
        echo ('<span style="background-color:#29af8a;">donations</span>');
    } else {
        echo ('<span style="background-color:#29af8a;">product</span>');
    }
    ...
    <table class="subtotal">
        ...
        <tr>
            <td class="myco2" rowspan="<?php echo $cols ?>"><br><br><br>
                <p>
                    <strong> Status : <?php ($order['order']->is_active == 0) ? "Due" : "Paid";?></strong>
                </p>
                <br>
                <p> Total Amount : <?php echo $order['order']->price; ?></p>
                <br>
                <p> Paid Amount : <?php echo ($order['order']->paid_amount) ? $order['order']->paid_amount : 0 ?>
                </p>
                <br>
            </td>
        ...
        <tr>
            <td>Amount Due :</td>
            <td><strong><?php echo (($order['order']->price + $order['order']->tax) - $order['order']->paid_amount); ?></strong></td>
        </tr>
        </tbody>
        </table>
</div>
